...
const Numbers: React.FC = () => {
  ...
  // send post to backend, sending the category type, in this case numbers as this is the numbers screen
  // receive task list for specified category
  ...
  const completedTaskIDsCall = async () => {
    try {
      ...
      // recieve list of completed tasks
  ...
  return (
    <View style={styles.container}>
      ...
      {/* draw a path between each lesson button */}
